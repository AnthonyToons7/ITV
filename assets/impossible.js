...
// impossible
function playImp(){
    const sprite = document.querySelector(".yspriteImp");
    const oppsprite = document.querySelector(".opp__sprite__impossible");
    const rngI = document.querySelector(".rngI");
    ...
    const styling = [
        ...
        {clnaam:'.gamemode', css:[{prop:'display', val:'none'},]},
        {clnaam:'.battle', css:[{prop:'display', val:'none'},]},
        {clnaam:'.patch__btn', css:[{prop:'display', val:'none'},]},
        {clnaam:'.wiki', css:[{prop:'display', val:'none'},]},
        {clnaam:'.left', css:[{prop:'display', val:'flex'},]},
        {clnaam:'.right', css:[{prop:'display', val:'flex'},]},
        {clnaam:'.flexboxIRight', css:[{prop:'display', val:'flex'},]},
        {clnaam:'.healthContainerI', css:[{prop:'display', val:'flex'},]},
        {clnaam:'.flexbox__Left__impossible', css:[{prop:'display', val:'flex'},]}
    ];
    ...
    // werkt niet als er meer dan een "=" is
    if (sprite.style.display = "none"){
        sprite.style.display="flex";
        oppsprite.style.display="flex";
        rngI.style.display="inline-block"
    }
    const ryhpi =  Math.floor(Math.random() * 550) + 2000;
    console.log("HP = " + ryhpi);
    const health = yhpi.dataset.yhpi = ryhpi;
...
function healI() {
    ...
    const yhpi = document.querySelector(".yhpI");
    // random heal amount
    const healing = Math.floor(Math.random() * 15) + 70;
...
function attackIB() {
    ...
    let x = Math.floor(Math.random() * 71) + 80;
...
function crashBusterI(){
    ...
    const container = document.querySelector(".ydmgI");
    let x = Math.floor(Math.random() * 25) + 150;
    let crit = Math.floor(Math.random() * 100) + 1;
...
function bloodshotI(){
    ...
    let x = Math.floor(Math.random() * 15) + 50;
    const hpi = document.querySelector(".hpI");
...
function attackI() {
    ...
    const container = document.querySelector(".ydmgI");
    let x = Math.floor(Math.random() * 21) + 50;
    document.querySelector(".ydmgI").innerHTML = x;
    if (!container.classList.contains('active')){
        container.classList.add('active');
    }
...
function oppAtk(){
    if (document.querySelector(".shieldeff").style.display === "block"){
        ...
        if (atkoption > 85){
            const hpi = document.querySelector('.hpI');
            const healing = Math.floor(Math.random() * 20) + 50;
...
function proceed(){
    ...
    setTimeout(function() {location.replace('https://anthonyschuurmans.nl/1Mastery_Test_RPG_port_ver/story_pages/story_2.html')}, 3000);
}