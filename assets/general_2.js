window.onload = function() {
    ...
    cross.addEventListener('click', ()=>{
        ...
        const bg = document.querySelector("#menu__active");
    ...
    scross.addEventListener('click', ()=>{
        ...
        const bg = document.querySelector("#bookactive");
        bg.style.display="none";
    });
    // X cross specials
    const mcross = document.querySelector(".specialx");
    mcross.addEventListener('click', ()=>{
        const menu = document.querySelector(".special__moves__impossible");
        menu.style.display = "none";
        const bg = document.querySelector("#moves__active");
        bg.style.display="none";
    });
    // X cross overlay
